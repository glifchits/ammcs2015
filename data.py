...
plenary = {
    ...
    "fischer": ('Paul', 'Fischer', 'University of Illinois', 'fischer.jpg'),
...
semi_plenary = {
    ...
    "bennett": ('Mike', 'Bennett', 'University of British Columbia', 'bennett.jpg'),
    "anco": ('Stephen', 'Anco', 'Brock University', 'anco.JPG')
}
